...
class DiaProcess():
    ...
    def __init__(self, fields, shutdownInitQueue, shutdownRespQueue, ProcessingType, isPlotted, dataQueue, visualQueue, processingQueue, alertIOqueue, positionQueue=0, accCalibration=0):
        ...
        self.process = multiprocessing.Process(target=DiaProcess.beginDataProcessing, args=(fields, ProcessingType, isPlotted, dataQueue, visualQueue, processingQueue, alertIOqueue, shutdownInitQueue, positionQueue, accCalibration))
    ...
    def beginDataProcessing(fields, ProcessingType, isPlotted, dataQueue, visualQueue, processingQueue, alertIOqueue, externalShutdownInitQueue, positionQueue, accCalibration):
        pid = os.getpid()
        ...
        if name == "Vibration": # Send position queue to vibration processing
            processing = ProcessingType(fields.alertDataType, name, fields.units, fields.samplingRate, fields.startTime, isPlotted, dataQueue, visualQueue, processingQueue, positionQueue, accCalibration)
        else:
